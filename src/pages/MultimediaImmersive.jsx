...
import { ArrowRight, CheckCircle2, Sparkles, Maximize, Video, Eye, Box, Film, Globe, Layers, Zap, MapPin, Microscope } from 'lucide-react';

const highlights = ['Imagine', 'Build', 'Orchestrate'];
...
export default function MultimediaImmersive() {
  useEffect(() => {
    document.title = 'Multimedia & Immersive - Orchestra Media';
  }, []);
    ...
    <div className="bg-[#0a1628]">
      ...
      <section className="relative pt-32 pb-20 min-h-[400px] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            src="/assets/images/1558618666-fcd2-large.webp"
            alt="Multimedia & Immersive"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full text-center">
          ...
          >
            <span className="inline-block px-6 py-2 rounded-full bg-[#8B1538]/20 backdrop-blur-sm text-[#C9A227] text-sm font-bold tracking-wider uppercase mb-6 border border-[#8B1538]/30">
              EXTRA SERVICES - MULTIMEDIA & IMMERSIVE
            </span>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-white/60 text-xl max-w-3xl mx-auto leading-relaxed">
              Turn walk-bys into stand-stays. We design and deliver <strong className="text-white">immersive,
                interactive content</strong> that makes your booth a destination—AR/VR demos, giant LED canvases,
              projection mapping, holograms, touch and motion-reactive experiences.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <img
                    src="/assets/images/1558655146-9f40-medium.webp"
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-white/80 text-sm">Immersive Experiences</div>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Built for <strong className="text-white">global deployment</strong>, engineered for{' '}
                <strong className="text-white">reliability</strong>, and measured for{' '}
                <strong className="text-white">ROI</strong> (traffic, dwell, scans, meetings). We blend
                concept, content and code so your story isn&apos;t just seen—it&apos;s <em className="text-[#C9A227]">felt</em>.
              </p>
              <div className="flex gap-6">
                {highlights.map((highlight, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#8B1538] to-[#6d1029] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">

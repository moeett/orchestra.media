...
import { ArrowRight, CheckCircle2, Target, Search, Handshake, Sparkles, TrendingUp } from 'lucide-react';

const highlights = ['For exhibitors', 'For organisers', 'Strategic partnerships'];

const features = [
  {
    icon: Target,
    title: 'Sponsorship Strategy Development',
    description: 'We work with you to define clear objectives for sponsorships or partnerships. Based on your goals, we\'ll create a sponsorship strategy that targets the right events or platforms and outlines what <strong>success looks like.</strong>',
    outputs: 'sponsorship strategy documents, objective frameworks, event target lists, success metrics definition.'
  },
  {
    icon: Search,
    title: 'Opportunity Sourcing',
    description: 'Thanks to our extensive database of potential sponsors and industry contacts, we can quickly pinpoint opportunities that fit your brand. From global trade shows to niche conferences, we find venues that <strong>align with your target audience.</strong>',
    outputs: 'opportunity shortlists, venue analysis reports, partner profiles, industry contact recommendations.'
  },
  {
    icon: Handshake,
    title: 'Negotiation & Deal-Making',
    description: 'Our team handles the outreach and negotiation. We know the market rates and negotiate packages that maximize your benefits while optimizing costs, securing you a deal that delivers the <strong>highest ROI for your investment.</strong>',
    outputs: 'negotiated agreements, sponsorship packages, contract terms, ROI projections.'
  },
  {
    icon: Sparkles,
    title: 'Creative Activation & Integration',
    description: 'We don\'t just hang your logo on a banner – we help design creative activation plans to fully leverage the sponsorship. This could mean interactive brand booths, exclusive meet-and-greets, or <strong>content co-creation with your partner.</strong>',
    outputs: 'activation concepts, booth design integration, event programming, co-marketing materials.'
  },
  {
    icon: TrendingUp,
    title: 'ROI Tracking & Iteration',
    description: 'Using established KPIs and analytics tools, we closely monitor the outcomes. We deliver post-event reports that quantify the impact and provide <strong>insights for how to improve future sponsorships.</strong>',
    outputs: 'performance reports, KPI dashboards, ROI analysis, optimization recommendations.'
  }
];

export default function Sponsorship() {
  useEffect(() => {
    document.title = 'Sponsorship - Orchestra Media';
  }, []);
            ...
            >
              ...
              >
                <div className="text-center">
                  ...
                  <div className="text-white/80 text-sm">Successful Partnerships</div>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="space-y-4">
                {highlights.map((highlight, index) => (
                  <motion.div
                    ...
                    className="flex items-center gap-4 bg-gradient-to-r from-[#0a1628]/50 to-transparent rounded-2xl p-4 border border-white/5 hover:border-[#8B1538]/30 transition-all group"
                  >
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#8B1538] to-[#6d1029] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
